        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BluePrintImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pricing_TimeSlots_TimeSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fields_CreatedAt",
                table: "Fields",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Fields_District",
                table: "Fields",
                column: "District");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FieldTypes_CreatedAt",
                table: "FieldTypes",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_FieldTypes_IsActive",
                table: "FieldTypes",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pricing_CreatedAt",
                table: "Pricing",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Pricing_FieldId_TimeSlotId_DayOfWeek",
                table: "Pricing",
                columns: new[] { "FieldId", "TimeSlotId", "DayOfWeek" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Pricing_IsActive",
                table: "Pricing",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_Pricing_Price",
                table: "Pricing",
                column: "Price");

            migrationBuilder.CreateIndex(
                name: "IX_Pricing_TimeSlotId",
                table: "Pricing",
                column: "TimeSlotId");
