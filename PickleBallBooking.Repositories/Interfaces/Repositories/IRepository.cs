...
using PickleBallBooking.Repositories.Repositories.Collections;

namespace PickleBallBooking.Repositories.Interfaces.Repositories;
...
public interface IRepository<TEntity> where TEntity : class
{
    ...
    /// <summary>
    ///     Gets the <see cref="IPagedList{T}" /> based on a predicate, orderby delegate and page information. This method
    ///     default no-tracking query.
    /// </summary>
    ...
    /// <summary>
    ///     Returns an <see cref="IQueryable{TEntity}" /> for the entity type, allowing further query composition.
    /// </summary>
    /// <returns>
    ///     An <see cref="IQueryable{TEntity}" /> representing the query for the entity type.
    /// </returns>
